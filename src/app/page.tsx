  ...
  return (
    <div className="mx-0 h-full min-h-[90vh] relative overflow-hidden">
      ...
      <video
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] h-[450px] md:w-[990px] md:h-[915px] 2xl:w-auto 2xl:h-full object-cover -z-10"
      >
      ...
      {/* Content */}
      <div className="px-5 xl:px-10 flex justify-end h-2/5 w-full absolute bottom-0 left-0 flex-col space-y-6">
